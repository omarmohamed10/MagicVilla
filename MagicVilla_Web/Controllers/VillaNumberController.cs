...
namespace MagicVilla_Web.Controllers
{
    public class VillaNumberController : Controller
    {
        ...
        public async Task<IActionResult> IndexVillaNumber()
        {
            ...
            var response = await _villaNumberService.GetAllAsync<APIResponse>(HttpContext.Session.GetString("JWTToken"));
            if (response != null)
            {
        ...
        public async Task<IActionResult> CreateVillaNumber(VillaNumberCreateVM villaNumberCreatevm)
        {
            ...
            {
                var response = await _villaNumberService.CreateAsync<APIResponse>(villaNumberCreatevm.VillaNumber, HttpContext.Session.GetString("JWTToken"));
                if (response != null & response.IsSuccess)
                {
        ...
        public async Task<IActionResult> UpdateVillaNumber(int villaNo)
        {
            ...
            var response = await _villaNumberService.GetAsync<APIResponse>(villaNo, HttpContext.Session.GetString("JWTToken"));
            if (response != null && response.IsSuccess)
            {
            ...
            response = await _villaService.GetAllAsync<APIResponse>(HttpContext.Session.GetString("JWTToken"));
            if (response != null && response.IsSuccess)
            {
        ...
        public async Task<IActionResult> UpdateVillaNumber(VillaNumberUpdateVM model)
        {
            if (ModelState.IsValid)
            {
                ...
                var response = await _villaNumberService.UpdateAsync<APIResponse>(model.VillaNumber, HttpContext.Session.GetString("JWTToken"));
                if (response != null && response.IsSuccess)
                {
                    return RedirectToAction(nameof(IndexVillaNumber));
                }
        ...
        public async Task<IActionResult> DeleteVillaNumber(VillaNumberDeleteVM model)
        {
            ...
            var response = await _villaNumberService.DeleteAsync<APIResponse>(model.VillaNumber.VillaNo, HttpContext.Session.GetString("JWTToken"));
            if (response != null && response.IsSuccess)
            {
                return RedirectToAction(nameof(IndexVillaNumber));
            }
